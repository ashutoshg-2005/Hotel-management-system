...
public class EmployeeInfo extends JFrame implements ActionListener {
    ...
    public EmployeeInfo(){
        // Modern UI setup
        setTitle("Hotel Management System - Employee Information");
        ...
        JLabel headerTitle = new JLabel("EMPLOYEE INFORMATION", JLabel.CENTER);
        ...
        try {
            ...
            if (table.getRowCount() == 0) {
                JLabel noDataLabel = new JLabel("No employee records found", JLabel.CENTER);
        ...
        JLabel statusLabel = new JLabel(" Hotel Management System | Employee Information Panel");
